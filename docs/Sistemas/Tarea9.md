...
- **Nombre del proyecto:** ADC Luxometro y Servo con ADC
- **Equipo / Autor(es):** _Luis Javier Vega_  
- **Curso / Asignatura:** _Sistemas embebidos 1_  
- **Fecha:** _22/09/2025_  
- **Descripción breve:** Crear un codigo que me marca la luminosidad de 0-100% usando un LDR
...
- **Descripción breve:** Crear un codigo para mover un servo usando un potenciometro y un adc que vaya 0-180 grados
